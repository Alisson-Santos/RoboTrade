...
def estrategia_estrela_cadente(dados, ativo):
    ...
    if len(dados) < 3:
        # atualizar_texto("Dados insuficientes para identificar padrão de estrela cadente.") # Comentado para reduzir logs frequentes
        return
    ...
    # else: # Comentado para reduzir logs frequentes
...
def estrategia_martelo(dados, ativo):
    ...
    if len(dados) < 3:
        # atualizar_texto("Dados insuficientes para identificar padrão de martelo.") # Comentado para reduzir logs frequentes
        return
