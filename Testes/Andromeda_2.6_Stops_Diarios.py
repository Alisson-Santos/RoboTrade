...
root = tk.Tk()
root.title("Robo Trader - Andromeda 2.6")
...
def obter_lucro_diario():
    ...
    if historico_negociacoes:
        ...
        atualizar_texto("Nenhuma negociação encontrada no histórico de hoje.")
...
def iniciar_estrategia():
    ...
    while estrategia_ativa:
        ...
        if hora_atual >= 9 and hora_atual < 17:  # Horário de operação (10h às 18h)
            ticker = AtivoAoperar
